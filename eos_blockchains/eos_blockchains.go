...
// EosBlocksChainCheck 根据提币的数量，提币方地址以及目标方地址来检查提币是否已经confirmed.
// 返回值有两个：提币状态以及已收到的提币数量（扣除手续费）
func EosBlocksChainCheck(withdrawAmount float64, originalAddress string, targetAddress string) (status string, netWithdrawAmount float64, confirmations int64, err error) {
...
func main() {
	status, netReceiveAmount, confirmations, err := EosBlocksChainCheck(5000000000000000000, "0xa7652b40a9c9b392ab240cbcfb44885fc7c23271", "0x9e544993e4503a98b690dd4fb05492d79c1507f5")
	if err != nil {
