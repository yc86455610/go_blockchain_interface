...
// NeoBlocksChainCheck 根据提币的数量，提币方地址以及目标方地址来检查提币是否已经confirmed.
// 返回值有两个：提币状态以及已收到的提币数量（扣除手续费）
func NeoBlocksChainCheck(withdrawAmount float64, originalAddress string, targetAddress string) (status string, netWithdrawAmount float64, confirmations int64, err error) {
...
func main() {
	status, netReceiveAmount, confirmations, err := NeoBlocksChainCheck(2400000000000000, "0x0f68eb49b3b864824efcd7912087f8823c70abe8", "0xf24246e0d5399ea85dbdadcfdbc9e8f14490db58")
	if err != nil {
